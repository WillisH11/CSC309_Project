export const MenuItemsUser = [
  { title: "Dashboard", url: "/dashboard", cName: "nav-links" },
  { title: "My Wallet", url: "/wallet", cName: "nav-links" }, // New Hub Page
  { title: "Rewards", url: "/rewards", cName: "nav-links" }, // New Hub Page
];

export const MenuItemsCashier = [
