  ...
  return (
    <div className="manager-container">
      <div className="manager-header">
        ...
        <p style={{ color: "#666" }}>
          Complete system control - monitor performance and manage all
          resources.
        </p>
      </div>
      ...
      <div className="manager-dashboard-grid">
        ...
        <Link to="/manager/users" className="manager-card card-users">
          <div>
            ...
            <p>
              Verify accounts, manage roles (including manager/superuser), and
        ...
        >
          <div>
            ...
            <p>
              View complete history of all purchases, transfers, and redemptions
              across the system.
            </p>
          </div>
        </Link>
        ...
        <Link to="/manager/events" className="manager-card card-content">
          <div>
            ...
            <p>
              Full control over events, manage organizers, and publish
              promotional offers.
            </p>
          </div>
        </Link>
