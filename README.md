...
A comprehensive loyalty program application for the Computer Science Student Union, featuring role-based access control, event management, point tracking, and analytics.

## 🚀 Deployed Application
**URL:** [https://loyalty-program-production.up.railway.app](https://loyalty-program-production.up.railway.app) (Replace if different)
